...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@SpeedThon"))
...
async def join_channel(event):
    ...
    try:
        ...
        await sython1(JoinChannelRequest("@TeamKaido"))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**سورس سبيدثونيعمل بنجاح ⚡️**')
...
💞 مرحبا بك في اوامر سورس سبيدثون[ @SpeedThon ]
...
☻ قـائمة جميع اوامر التجميع التي تحتاجها لسورس سبيدثون
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('TeamKaido'))
        ...
        await sython1.send_message(event.chat_id, "تم الانتهاء من التجميع | 𝘀𝗽𝗲𝗲𝗱𝘁𝗵𝗼𝗻")
...
async def _(event):
    ...
    joinu = await sython1(JoinChannelRequest('SpeedThon'))
    ...
    while True:
        ...
        try:
            ...
            if sender.id == ownerhson_id:
                ...
                await sython1.send_message(pot, '**جاري بدأ عملية التجميع بواسطة سورس سبيدثون**')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joion = await sython1(JoinChannelRequest('TeamKaido'))
